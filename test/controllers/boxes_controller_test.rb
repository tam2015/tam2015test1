...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { name: @box.name, description: @box.description, step_id: @box.step_id, user_id: @box.user_id }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { name: @box.name, description: @box.description, step_id: @box.step_id, user_id: @box.user_id }
    assert_redirected_to box_path(assigns(:box))
  end
