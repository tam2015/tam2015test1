...
class PaymentNotificationsControllerTest < ActionController::TestCase
  ...
  test "should create payment_notification" do
    assert_difference('PaymentNotification.count') do
      post :create, payment_notification: { params: @payment_notification.params, paypal_customer_token: @payment_notification.paypal_customer_token, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id, user_id: @payment_notification.user_id }
    end
  ...
  test "should update payment_notification" do
    patch :update, id: @payment_notification, payment_notification: { params: @payment_notification.params, paypal_customer_token: @payment_notification.paypal_customer_token, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id, user_id: @payment_notification.user_id }
    assert_redirected_to payment_notification_path(assigns(:payment_notification))
  end
