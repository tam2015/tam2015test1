...
(function($) {
    ...
    $.jscroll = {
        defaults: {
            ...
            loadingHtml: '<div class="step-box active-box step-box-details loading"> Carregando ... </div>',
            padding: 0,
            nextSelector: 'a:last',
            contentSelector: '',
            pagingSelector: '',
    ...
    var jScroll = function($e, options) {
        ...
        function _load() {
            var _this = this,
                ...
                data = $e.data('jscroll'),
                exist_nextHref = !(_.isUndefined(data.nextHref) || data.nextHref == "undefined")
                ;
            ...
            return $e.animate({scrollTop: $inner.outerHeight()}, 0, function() {
                if (_options.load) {
                  loadCallback = _options.load.call();

                  if (loadCallback.done && typeof loadCallback.done === 'function') {
                    loadCallback.done(function() {
                      loading();
                    });
                  };
                } else {
