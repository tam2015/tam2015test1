      ...
      @_options = $.extend
        ...
        template: "<div class='popover'>
          ...
          <div class='popover-navigation'>
            <div class='btn-group'>
              <button class='btn btn-sm btn-default' data-role='prev'>&laquo; Voltar</button>
              <button class='btn btn-sm btn-default' data-role='next'>Próximo &raquo;</button>
              <button class='btn btn-sm btn-default' data-role='pause-resume' data-pause-text='Pausar' data-resume-text='Continuar'>Pausar</button>
            </div>
            <button class='btn btn-sm btn-default' data-role='end'>Pular</button>
          </div>
        </div>"
